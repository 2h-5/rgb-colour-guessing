    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file, 6, 4, 85);
    			attr_dev(link, "rel", "stylesheet");
    			attr_dev(link, "type", "text/css");
    			attr_dev(link, "href", "style.css");
    			add_location(link, file, 7, 4, 160);
    			add_location(head, file, 5, 0, 73);
    			attr_dev(span, "id", "colour-to-guess");
    			add_location(span, file, 14, 8, 282);
    			add_location(h1, file, 12, 4, 243);
    			attr_dev(button0, "id", "restart");
    			add_location(button0, file, 21, 12, 453);
    			attr_dev(button1, "id", "hint");
    			add_location(button1, file, 22, 12, 504);
    			attr_dev(div0, "id", "left-controls");
    			add_location(div0, file, 20, 8, 415);
    			attr_dev(div1, "id", "result-message");
    			add_location(div1, file, 25, 8, 580);
    			attr_dev(button2, "class", "mode selected");
    			attr_dev(button2, "data-mode", "easy");
    			add_location(button2, file, 28, 12, 661);
    			attr_dev(button3, "class", "mode");
    			attr_dev(button3, "data-mode", "hard");
    			add_location(button3, file, 30, 12, 765);
    			attr_dev(div2, "id", "mode-controls");
    			add_location(div2, file, 27, 8, 623);
    			attr_dev(div3, "id", "menu");
    			add_location(div3, file, 18, 4, 388);
    			attr_dev(div4, "id", "container");
    			add_location(div4, file, 35, 4, 854);
    			attr_dev(a, "href", "https://github.com/2h-5/rgb-colour-guessing");
    			attr_dev(a, "id", "creator-link");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file, 41, 12, 1041);
    			attr_dev(div5, "class", "nav-logo-down");
    			add_location(div5, file, 40, 8, 1000);
    			attr_dev(div6, "class", "nav-links-down");
    			add_location(div6, file, 44, 8, 1187);
    			attr_dev(nav, "class", "navbar-down");
    			add_location(nav, file, 39, 4, 965);
    			attr_dev(script, "type", "text/javascript");
    			if (!src_url_equal(script.src, script_src_value = "script.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file, 49, 4, 1289);
    			add_location(body, file, 10, 0, 229);
    		},
